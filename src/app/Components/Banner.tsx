      ...
      {path === "/" ? (
        <>
          <div className="w-full relative mx-auto h-auto" >
            <div className="relative w-full mx-auto flex flex-col items-center justify-center pt-40 px-4 lg:px-30 xl:px-30 gap-12">
              <article className="relative z-10 flex flex-col items-center gap-5 justify-center h-full text-center text-white">
                ...
                <p className="text-sm text-gray-700/60 w-130 font-medium tracking-wider leading-8">
