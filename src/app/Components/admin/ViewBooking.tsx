...
import { getAdminBooking} from '@/redux/slices/cardSlice';
...
const ViewBooking = () => {
  ...
  useEffect(()=>{
    dispatch(getAdminBooking({page:currentPage,limit:10})).unwrap().then((res)=>{
  ...
  return (
    ...
    <h4 className="text-xl font-semibold">Booking Calls</h4>
