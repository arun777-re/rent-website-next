...
import { getFeatured } from '@/redux/slices/propertSlice';
import { BiSolidSkipNextCircle,BiSolidSkipPreviousCircle } from "react-icons/bi";

const FeaturedPrprty: React.FC = () => {
  ...
  useEffect(() => {
    dispatch(getFeatured({ page: currentPage, limit: 12 }))
      .unwrap()
      .then((res) => {
