...
import {getRentedProperties } from '@/redux/slices/propertSlice';
import { BiSolidSkipNextCircle,BiSolidSkipPreviousCircle } from "react-icons/bi";

const RentedPrprty: React.FC = () => {
  ...
  useEffect(() => {
    dispatch(getRentedProperties({ page: currentPage, limit: 12 }))
      .unwrap()
      .then((res) => {
  ...
  return (
    <section className="w-full min-h-screen relative space-y-4">
      <h4 className="text-xl font-semibold">Rented Properties</h4>
