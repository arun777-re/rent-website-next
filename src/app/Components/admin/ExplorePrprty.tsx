...
import { getAllProperty } from '@/redux/slices/propertSlice';
import { BiSolidSkipNextCircle,BiSolidSkipPreviousCircle } from "react-icons/bi";

const ExplorePrprty: React.FC = () => {
  ...
  useEffect(() => {
    dispatch(getAllProperty({ page: currentPage, limit: 12 }))
      .unwrap()
      .then((res) => {
